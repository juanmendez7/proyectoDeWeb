...
import "./estilos-juegos/origenCambio.css"
...
const OrigenCambio = () =>{
    ...
    return (
        ...
        <div className="div">
          ...
          <div className="minijuegos">Desde el origen del cambio climatico</div>
